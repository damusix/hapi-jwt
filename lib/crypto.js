...
export const generate = function (value, algorithm, key) {
...
export const verify = function (raw, algorithm, key) {
    ...
    switch (algorithm) {
        ...
        case 'HS512': {
            ...
            const compare = generate(value, algorithm, key);
...
export const certToPEM = function (cert) {

    return `-----BEGIN CERTIFICATE-----\n${internals.chop(cert)}\n-----END CERTIFICATE-----\n`;
};


export const rsaPublicKeyToPEM = function (modulusB64, exponentB64) {
